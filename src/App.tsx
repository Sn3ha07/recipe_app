  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-100/70">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        {showWelcome && (
          <div className="bg-emerald-900 text-emerald-50 rounded-3xl p-5 sm:p-6 shadow-sm border border-emerald-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-start gap-3.5">
              <div className="p-2.5 rounded-2xl bg-emerald-700/80 text-emerald-200 font-bold shrink-0">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-emerald-800/80 hover:bg-emerald-700 text-emerald-100 text-xs font-semibold transition-colors border border-emerald-700"
                  >
            ...
            <button
              ...
              className="self-start sm:self-center text-emerald-300 hover:text-white p-1 rounded-lg transition-colors cursor-pointer"
