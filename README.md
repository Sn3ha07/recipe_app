...
4. **Find recipes.** You can do this four ways:
   - Click **Cook With These Now** in the Rescue Alert box to favor recipes that use up the ingredients about to expire. The **Rescue Expiring** button on the Recipes tab does the same thing.
